...
@push('styles')
<style>
    /* Additional variables for contact page */
    :root {
        ...
        --form-text: #333;
        --form-border: #ced4da;
        --form-focus-shadow: rgba(30, 136, 229, 0.25);
    ...
    body[data-theme="dark"] {
        ...
        --form-text: #f8f9fa;
        --form-border: #495057;
        --form-focus-shadow: rgba(30, 136, 229, 0.5);
        --accordion-active-bg: #343a40;
        --faq-section-bg: #1a1a1a;
    }

    .contact-hero {
        background: linear-gradient(var(--hero-overlay), var(--hero-overlay)), url('https://images.unsplash.com/photo-1596524430615-b46475ddff6e?ixlib=rb-4.0.3&ixid=M3wxMjA3fDB8MHxwaG90by1wYWdlfHx8fGVufDB8fHx8fA%3D%3D&auto=format&fit=crop&w=1770&q=80');
...
<script>
    document.addEventListener('DOMContentLoaded', function() {
        ...
        // This script is only for form validation
    });
</script>
@endpush
