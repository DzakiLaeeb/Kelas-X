            ...
            <Col lg={6}>
              <div className="hero-content">
                <h1 className="hero-title">
                  Welcome to <span className="text-gradient">Prismatic</span> Restaurant
                </h1>
                <p className="hero-subtitle">
                  Experience culinary excellence with our innovative dishes and exceptional service.
        ...
        <Container>
          <Row className="mb-5">
            <Col className="text-center">
              <h2 className="section-title text-white">Popular Menu</h2>
              <p className="section-subtitle text-white">Try our most loved dishes</p>
            </Col>
          </Row>
